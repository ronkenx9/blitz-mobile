                ...
                {mode === 'ai' ? (
                        ...
                        <View style={styles.actionSection}>
                            ...
                            <ArcadeButton
                                ...
                                onPress={() => {
                                    ...
                                    router.push(`/game/bidding?id=${gameId}&mode=ai`);
                                }}
                            />
                    ...
                    <View style={styles.pvpSection}>
                        ...
                        <PixelBox variant="panel2" style={styles.gameIdBox}>
                            <Text style={styles.gameIdText}>741829563</Text>
                            <Text style={styles.gameIdSubtext}>SHARE THIS ID TO INVITE PLAYERS</Text>
                        </PixelBox>
...
const styles = StyleSheet.create({
    ...
    statusInfo: {
        ...
        borderColor: 'rgba(79,163,232,0.3)',
    },
    statusText: {
        fontFamily: THEME.fonts.vt,
        fontSize: 14,
